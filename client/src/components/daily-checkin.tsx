  ...
  return (
    <div className="px-6 py-6">
      ...
      <div className="space-y-6">
        ...
        <Card className="shadow-lg">
          <CardContent className="p-6">
            <h4 className="font-semibold text-deep-teal mb-4">Have you cared for your body today?</h4>
            <div className="grid grid-cols-2 gap-3">
        ...
        <Card className="shadow-lg">
          <CardContent className="p-6">
            <h4 className="font-semibold text-deep-teal mb-4">Do you feel supported right now?</h4>
            <div className="grid grid-cols-2 gap-3">
