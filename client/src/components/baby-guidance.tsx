...
import { ChevronLeft, ChevronRight, Baby, Heart, Brain, Sparkles, Target, BookOpen, AlertCircle, X, Star } from "lucide-react";
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {user.isPostpartum ? "Parenting Tools" : "Planning Tools"}
          </CardTitle>
          <p className="text-sm text-muted-foreground">
            {user.isPostpartum ? "Resources for your baby's growth and development" : "Helpful tools for your journey ahead"}
          </p>
        </CardHeader>
        <CardContent>
